...
namespace RealtimeMultiplayerGame.modules.circlecollision {
    ...
    export class PackedCircle {
        constructor() {
            this.boundsRule = this.BOUNDS_RULE_IGNORE;
        ...
        public position = new RealtimeMultiplayerGame.model.Point();
        /**
        ...
        public setOffset(aPosition) {
            this.offset = aPosition;
            return this;
        };

        public setTargetPosition(aTargetPosition) {
            this.targetPosition = aTargetPosition;
            return this;
        };

        public setTargetChaseSpeed(aTargetChaseSpeed) {
            this.targetChaseSpeed = aTargetChaseSpeed;
            return this;
        };

        public setIsFixed(value) {
            this.isFixed = value;
            return this;
        };

        public setCollisionMask(aCollisionMask) {
            this.collisionMask = aCollisionMask;
            return this;
        };

        public setCollisionGroup(aCollisionGroup) {
            this.collisionGroup = aCollisionGroup;
            return this;
        };

        public setRadius(aRadius) {
            this.radius = aRadius;
            this.radiusSquared = this.radius * this.radius;
            return this;
        };

        public initialize(overrides) {
            if (overrides) {
                for (var i:number in overrides) {
                    this[i] = overrides[i];
                }
            }
